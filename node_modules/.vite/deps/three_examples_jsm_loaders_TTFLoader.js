...
function makeColrTable(ref) {
  ...
  if (baseGlyphRecords === void 0) baseGlyphRecords = [];
  var layerRecords = ref.layerRecords;
  if (layerRecords === void 0) layerRecords = [];
  check.argument(version === 0, "Only COLRv0 supported.");
...
function makeCpalTable(ref) {
  ...
  if (numPaletteEntries === void 0) numPaletteEntries = 0;
  var colorRecords = ref.colorRecords;
  if (colorRecords === void 0) colorRecords = [];
  var colorRecordIndices = ref.colorRecordIndices;
  if (colorRecordIndices === void 0) colorRecordIndices = [0];
...
*/
//# sourceMappingURL=three_examples_jsm_loaders_TTFLoader.js.map
